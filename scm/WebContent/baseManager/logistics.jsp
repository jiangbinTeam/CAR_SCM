    ...
    <td valign="top" bgcolor="#F7F8F9">
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_table">
				<tr>
					...
					<td>当前位置：基础资料>>物流公司</td>
				</tr>
			</table>
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_table">
				<tr>
				  <td width="40%" align="center">
				  	<input type="button" class="Submit" style="width:100px" value="添加物流公司" onclick="window.location='logisticsCreate'"/>
				  </td>
				</tr>
			</table>
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_table" style="text-align: center;">
				...
				<tbody class="tbody">
					<c:forEach items="${requestScope.logisticsList }" var="logistics" varStatus="i" >
						<tr>
							<td>${i.index+1}</td>
							<td>${logistics.logisticsName}</td>
							<td>${logistics.logisticsTel}</td>
							<td>${logistics.logisticsContact}</td>
							<td>${logistics.logisticsContactTel}</td>
							<td>
							<a href="logisticsCreate?logisticsId=${logistics.logisticsId}" style="color:#000099">修改</a>		
							</td>
						</tr>
					</c:forEach>
				</tbody>						
