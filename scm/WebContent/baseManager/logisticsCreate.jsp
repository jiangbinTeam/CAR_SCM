    ...
    <td valign="top" bgcolor="#F7F8F9">
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_table">
				<tr>
					...
					<td>当前位置：基础资料>>物流公司>>物流公司信息维护</td>
				</tr>
			</table>
			<form action="logisticsEdit" method="post">
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_table">
				<tbody class="tbody2">
					<tr>
						<td width="8%" align="left"><strong><span>公司名称</span></strong></td>
						<c:if test="${!empty logistics}">
							<td width="26%" align="left">
								<input name="logisticsName"  type="text" class="text_2000" 
								style="width:200px" value="${requestScope.logistics.logisticsName}">
							</td>
						</c:if>
						<c:if test="${empty logistics}">
							<td width="26%" align="left">
								<input name="logisticsName" required="required"  required="required"  type="text" class="text_2000" style="width:200px">
							</td>
						</c:if>
						<td width="10%" align="left"><strong><span>公司电话</span></strong></td>
						<c:if test="${!empty logistics}">
							<td width="56%" align="left">
							<input name="logisticsTel" required="required"   type="text" style="width:200px" class="text_2000"  
								value="${requestScope.logistics.logisticsTel}">
							</td>
						</c:if>
						<c:if test="${empty logistics}">
							<td width="56%" align="left">
								<input name="logisticsTel" required="required"    type="text" style="width:200px" class="text_2000"></td>
						</c:if>
					</tr>
					
					<tr>
						<td width="8%" height="27" align="left"><strong><span>联系人</span></strong></td>
						<c:if test="${!empty logistics}">
							<td width="26%" align="left">
								<input name="logisticsContact" required="required"   type="text" class="text_2000" style="width:200px"
							 value="${requestScope.logistics.logisticsContact}"></td>
						</c:if>
						<c:if test="${empty logistics}">
							<td width="26%" align="left">
								<input name="logisticsContact" required="required"   type="text" class="text_2000" style="width:200px"></td>
						</c:if>
					
						<td width="10%" align="left"><strong><span>联系人手机</span></strong></td>
						<c:if test="${!empty logistics}">
							<td width="56%" align="left">
								<input name="logisticsContactTel" required="required"  type="text" class="text_2000" style="width:200px"  
									value="${requestScope.logistics.logisticsContactTel}">
							</td>
						</c:if>
						<c:if test="${empty logistics}">
							<td width="56%" align="left">
								<input name="logisticsContactTel" required="required"   type="text" class="text_2000" style="width:200px"></td>
						</c:if>
					</tr>
					<tr>
						...
						<td width="56%" align="left">
							<input type="hidden" name="logisticsId" value="${requestScope.logistics.logisticsId}">
