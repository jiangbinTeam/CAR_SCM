    ...
    <td width="182" valign="top"><div id="container">
	  ...
	  <div class="content">
	   ...
	   <div class="content">
        ...
        <ul class="MM">
           <c:if test="${user.enabled==1 || user.enabled==2}">
	         <li><a href="yearSellPlan_page" target="main">制定全年销售计划</a></li>
          <li><a href="yearSellPlan_findAllMonth" target="main">全年销售计划查询</a></li>
          <li><a href="yearSellPlan_findAlDea" target="main">全年经销商销售计划查询</a></li>
	          <li><a href="findAllDealer" target="main">经销商订单管理</a></li>
	          <li><a target="main" href="startAone">发车台帐管理</a></li>
	          <li><a href="dealerSellPlanCensor" target="main">经销商销售计划审查</a></li>
			  <li><a href="dealerSettlementListAll" target="main">经销商费用结算</a></li>
		   </c:if>
        </ul>
      </div>
      ...
      <div class="content">
	   ...
	   <div class="content">
        ...
        <ul class="MM">
          ...
          <c:if test="${user.enabled==1 || user.enabled==4}">
          	<li><a href="InvoiceAll" target="main">发车管理</a></li>
          </c:if>
        </ul>
      </div>
	   ...
	   <div class="content">
        ...
        <ul class="MM">
           <c:if test="${user.enabled==1 || user.enabled==4}">
	          <li><a href="Warehouselist" target="main">仓库管理</a></li>
	          <li><a href="Warehousekulist" target="main">库位管理</a></li>
	          <li><a href="CarOutManagerlist" target="main">汽车出库管理</a></li>
			  <li><a href="CarInManagerlist" target="main">汽车入库管理</a></li>
			</c:if> 
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <c:if test="${user.enabled==1 || user.enabled==6}">
			  ...
			  <li><a href="authority" target="main">权限权限管理</a></li>
		  </c:if>
        </ul>
      </div>
	  ...
	  <div class="content">
        ...
        <ul class="MM">
         <c:if test="${user.enabled==1 || user.enabled==5}">
			  ...
			  <li><a href="Billinglist" target="main">开票</a></li>
		 </c:if>
        </ul>
      </div>
