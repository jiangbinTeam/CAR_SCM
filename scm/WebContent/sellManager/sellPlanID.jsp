				...
				<table width="98%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td width="100%" align="center"><input type="button"
							value="返回" style="width:100px"
							onclick="window.location.href='${pageContext.request.contextPath}/yearSellPlan_page'" /></td>

					</tr>
				</table>
				<table width="98%" border="0" align="center" style="text-align: center;" cellpadding="0"
					cellspacing="0" class="line_table">
					<thead class="thead">
						<tr>
							<th width="6%">序号</th>
							...
							<th width="19%">车型特征</th>
							<th width="15%">计划采购</th>
							<th width="18%">计划销售数量</th>
						</tr>
					</thead>
					<tbody class="tbody">
						<form action="${pageContext.request.contextPath}/yearSellPlan_update">
							<tr>
								<td>${i.index+1 }</td>																															
								...
								<td>${selectSell.carCharacter }</td>
								<td><a style="color:#CC0000">${selectSell.yearProcurementPlanCount }</a></td>
								<td width="20%"><input type="text"  name="sellcount" value="${selectSell.sellcount}" class="login_text" style="width: 100px" />
								<input type="Submit" value="保存销售计划"  /></td>
							</tr>
						</form>
