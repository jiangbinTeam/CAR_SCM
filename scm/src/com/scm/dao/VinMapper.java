...
public interface VinMapper {
	...
	@Update("update vin set outOfStorage=#{outOfStorage} where VINNUMBER=#{vinNumber}")
	int modifyOutOfStorage(@Param("outOfStorage")int outOfStorage,@Param("vinNumber")String vinNumber);
}
