...
public class CarOutManagerController {
	...
	public ModelAndView findBychuku(@RequestParam(value = "currPage", required = true) Integer currPage,
		...
		int pageSize = 10;
		int count = carOutManagerService.totalcount(warehouseId, typeCode, vinNumber);
	...
	public String save1(Integer storageAreasId,String vinNumber) {
	
		if (storageAreasId != null) {
			carOutManagerService.findBychukua(storageAreasId,vinNumber);
		}
